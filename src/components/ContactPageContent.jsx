            ...
            <div className="flex flex-1 h-full">
                ...
                <div className="w-1/3 flex flex-col justify-center px-8 relative">
                    ...
                    <div className="max-w-[386px] mx-auto">
                        ...
                        <p className="text-[9px] font-mono uppercase tracking-wider text-black leading-[1.3] text-justify mb-16">
                        ...
                        <div className="space-y-10">
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full h-[20px] bg-transparent border-none outline-none text-[9px] font-mono tracking-wider text-black resize-none"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full h-[80px] bg-transparent border-none outline-none text-[9px] font-mono tracking-wider text-black resize-none"
                                    style={{ backgroundColor: 'rgba(235,234,230,1)' }}
                                />
                                <div className="w-full h-[1px] bg-black mb-6"></div>
                            </div>
